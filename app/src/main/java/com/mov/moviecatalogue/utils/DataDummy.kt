...
object DataDummy {
    ...
    fun genMovie() =
        gson.fromJson(loadJSON("assets/movies.json"), MoviesResponse::class.java).result

    fun genTv() =
        gson.fromJson(loadJSON("assets/tv.json"), TvShowResponse::class.java).result

    private fun loadJSON(fileSource: String): String? {
        var json: String? = null
        try {
            val input: InputStream =
                this.javaClass.classLoader!!.getResourceAsStream(fileSource) //context.assets.open(fileSource)
